...
class ProfileDataUpdate with UserProfileProviderService {
  ...
  Future<void> updateBio({required String bioText}) async {
    ...
    final response = await ApiClient.put(ApiPath.updateUserBio, {
      'bio': bioText,
  ...
  Future<void> updatePronouns({required String pronouns}) async {
    ...
    final response = await ApiClient.put(ApiPath.updateUserPronouns, {
      'pronouns': pronouns,
      'username': userProvider.user.username
    });    
  ...
  Future<void> updateCountry({required String country}) async {
    ...
    final response = await ApiClient.put(ApiPath.updateUserCountry, {
      'country': country,
      'username': userProvider.user.username
    });    
